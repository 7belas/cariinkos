                ...
                <div class="form-row">
                    <div class="form-group col-12 col-sm-12 col-md-12 col-lg-6 col-xl-5">
                        ...
                        <div class="input-group">
                            ...
                            <input value="{{ $currentdata->admin_username }}" required class="form-control" type="text" id="username" name="username"/>
                        </div>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-12 col-sm-12 col-md-12 col-lg-6 col-xl-5">
                        ...
                        <div class="input-group">
                            ...
                            <input value="{{ $currentdata->admin_nama }}" required class="form-control" type="text" id="nama" name="nama"/>
                        </div>
                    </div>
                </div>
                <div class="form-row">
